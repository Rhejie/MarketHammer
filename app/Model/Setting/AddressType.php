...
class AddressType extends \App\Model\BaseModel
{
    ...
    {
        return $this->hasOne(FieldValueTranslator::class, 'table_id')->where('table', 'address_type');
    }
    ...
    {
        return $this->hasMany(FieldValueTranslator::class, 'table_id')->where('table', 'address_type');
    }
