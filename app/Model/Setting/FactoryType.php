...
class FactoryType extends \App\Model\BaseModel
{
    /**
     * Set the table that this model will manage
     */
    protected $table = 'factory_type';
    ...
    {
        return $this->hasOne(FieldValueTranslator::class, 'table_id')->where('table', 'factory_type');
    }
    ...
    {
        return $this->hasMany(FieldValueTranslator::class, 'table_id')->where('table', 'factory_type');
    }
