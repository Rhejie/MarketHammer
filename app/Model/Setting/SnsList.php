...
class SnsList extends \App\Model\BaseModel
{
	/**
	 * Set the table that this model will be manipulating
	 */
	protected $table = 'sns_list';
    ...
    {
        return $this->hasOne(FieldValueTranslator::class, 'table_id')->where('table', 'sns_list');
    }
    ...
    {
        return $this->hasMany(FieldValueTranslator::class, 'table_id')->where('table', 'sns_list');
    }
