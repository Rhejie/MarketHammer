...
class FormSubmissionStatus extends \App\Model\BaseModel
{
    protected $fillable = ['name'];

    public function translator()
    {
        return $this->hasOne(FieldValueTranslator::class, 'table_id')->where('table', 'form_submission_statuses');
    }
    ...
    {
        return $this->hasMany(FieldValueTranslator::class, 'table_id')->where('table', 'form_submission_statuses');
    }
