...
class CertificationHolder extends Model
{
    use SoftDeletes;
    
    protected $table = 'certification_holder';
    ...
    {
        return $this->hasOne(FieldValueTranslator::class, 'table_id')->where('table', 'certification_holder');
    }
    ...
    {
        return $this->hasMany(FieldValueTranslator::class, 'table_id')->where('table', 'certification_holder');
    }
