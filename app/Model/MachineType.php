...
class MachineType extends Model
{
    ...
    {
        return $this->hasOne(FieldValueTranslator::class, 'table_id')->where('table', 'machine_type');
    }
    ...
    {
        return $this->hasMany(FieldValueTranslator::class, 'table_id')->where('table', 'machine_type');
    }
