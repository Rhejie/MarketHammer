...
use App\Repositories\Buyer\FormSubmissionGroupRepository;

class FormSubmissionGroupController extends Controller
{
	public function __construct(FormSubmissionGroupRepository $repository)
    {
