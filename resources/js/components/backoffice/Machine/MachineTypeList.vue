<template>
    <div class="main-container">
        <div class="table-container">
            <div class="card borderless">
                ...
                <el-table
                    ...
                    @row-click="editData"
                >
                    <el-table-column prop="name" :label="__('Machine Type')" :sortable="true">
        ...
        <el-dialog
            :title="mode == 'create' ? 'Add New Machine Type' : 'Update Machine Type'"
        ...
        >
            ...
            >
                <el-form-item :label="__('Machine Type')" prop="name">
                    <el-input
                        v-model="modelForm.name"
                        :placeholder="__('Machine Type')"
                    ></el-input>
...
export default {
        ...
        return {
            ...
            modelFormRules: {
                name: [
                    {
                        required: true,
                        message: this.__("Please input machine type name"),
                        trigger: "blur"
                    }
                ]
            },
    ...
    methods: {
        showList() {
            ...
            this.$API.MachineType.showTypes(params)
                .then(result => {
                    let res = result.data;
                    this.typeList = res.type.data;
                    this.typePagination = res.type;
                })
                .catch(err => {
        ...
        storeData() {
            ...
            this.$API.MachineType.storeType(postData)
                .then(res => {
                    this.$notify({
        ...
        updateData() {
            ...
            this.$API.MachineType.updateType(postData)
                .then(res => {
                    this.$notify({
                        title: this.__("Success"),
        ...
        deleteData(id, index) {
            this.$API.MachineType.destroyType(id)
                .then(res => {
                    this.$notify({
                        title: this.__("Success"),
