<template>
	<div class="event-component-index container">
									...
									<el-form
										...
										<el-form-item
											...
											<el-select
												...
												<el-option
													v-for="business in pageData.businessList"
													:key="business.value"
        ...
        <el-dialog
        	...
        	:title="eventForm.id ? 'Update Event' : 'Add New Event'"
        	width="60%"
        	top="4vh">
        	<el-form
        		v-loading="saving"
        		...
        		<el-row
        			...
        			<el-col :xl="12" :lg="12" :md="24" :sm="24">
		        		...
		        		<el-form-item
		        			label="Business"
		        			prop="businessListID"
		        			:error="hasError('businessListID', true)">
		        			<el-select
		        				v-model="eventForm.businessListID"
		        				clearable
		        				filterable
		        				class="full-width">
		        				<el-option 
		        					v-for="business in pageData.businessList" :key="business.key" 
		        					:label="business.label" 
		        					:value="business.value">
	        					</el-option>
		        			</el-select>
        			...
        			<el-col :xl="12" :lg="12" :md="24" :sm="24">
        				<el-form-item
        					label=""
        					prop="is_active"
        					:error="hasError('is_active', true)">
        					<el-checkbox v-model="eventForm.is_active">Active</el-checkbox>
        				</el-form-item>
        				<el-form-item
		        			label="Redirect URL"
		        			prop="link"
		        			:error="hasError('link', true)">
		        			<el-input
		        		...
		        		<el-form-item label="Banner Upload">
		        			<el-upload
			        			...
			        			:file-list="eventForm.medias"
			        			multiple>
			        			<i class="el-icon-upload"></i>
			        			<div class="el-upload__text">Drop file here or <em>click to upload</em></div>

			        			<div slot="file" slot-scope="{file}">
		        					<a class="el-upload-list__item-name" :href="`/storage/${file.url}`" target="_blank">
